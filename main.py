...
#MONO SOLO/DUO
          ...
          embed = discord.Embed(
              title=f"Level: {lvl}",
              description=
              f"Solo/Duo Wins: **{wins}** Losses: **{losses}** Wins behind or ahead: **{wins - losses}** with **{wins/losses*wins}%**winrate  \n Flex Wins: No wins or losses",
...
#MONO FLEX
          ...
          embed = discord.Embed(
              title=f"Level: {lvl}",
              description=
              f"Solo/Duo No Wins or Losses  \n Flex Wins: **{wins}** Losses: **{losses}** Wins behind or ahead: **{wins - losses}** with **{wins/losses*wins}%**winrate",
              colour=discord.Colour.purple())
          embed.add_field(
              name="Flex",
              value=
